          ...
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center">
              ...
              <button
                ...
                className="lg:hidden p-2 -ml-2 text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100"
              ...
              {/* Desktop navigation */}
              <nav className="hidden lg:flex lg:ml-8 lg:gap-1" aria-label="Main navigation">
                {navLinks.map((link) => {
                  ...
                  return (
                    <Link
                      ...
                      href={link.href}
                      className={cn(
                        'px-4 py-2 rounded-lg text-sm font-medium transition-all focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-inset',
                        isActive
